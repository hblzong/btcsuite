...
type secp256k1DSA struct {
	...
	signDSA     func(priv PrivateKey, hash []byte) (r, s *big.Int, err error)
...
func (sp secp256k1DSA) SignDSA(priv PrivateKey, hash []byte) (r, s *big.Int,
	err error) {
	r, s, err = sp.signDSA(priv, hash)
	return
}
